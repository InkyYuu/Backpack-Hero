...
public class Melee implements Weapons {
	private int UID = 0;
	...
	public Melee(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn, HashMap<String, Integer> onUse, int[][] size, int energy, int gold, int mana, String rarety, String description) {
	...
	@Override
	public Melee copie() {
		return new Melee(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size, cost.get("Energy"), cost.get("Gold"), cost.get("Mana"), rarety, description);
	}
