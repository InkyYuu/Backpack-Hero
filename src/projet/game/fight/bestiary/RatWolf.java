...
public class RatWolf implements Bestiary,Effects{
	...
	public RatWolf(int health) {
		...
		this.shield = new int[]{13,16};
		this.nextAction = prediction();
		this.description = "The ratwolf has long patrolled these halls, killing adventurers who stray too far";
	}
