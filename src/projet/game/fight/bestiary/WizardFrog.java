...
public class WizardFrog implements Bestiary,Effects{
	...
	public WizardFrog(int health) {
		this.imgPath = "WizardFrog.png";
		this.health = health;
		this.protection = 0;
		this.maxHealth = 45;
		this.isAlive = true;
		...
		this.description = "Frogs know about a deep magic that appears on rare Wednesdays";
	}
